...
const userSlice = createSlice({
  ...
  reducers: {
    ...
    setBadgeType: (state, action) => {
      ...
      let badge = null;
      if (percentage >= 80) badge = { id: 'gold', name: 'Gold Medal', icon: '🥇' };
      else if (percentage >= 50) badge = { id: 'silver', name: 'Silver Medal', icon: '🥈' };
...
export const { setUser, clearUser, setLoading, setError, addPoints, completeQuiz, setBadgeType } = userSlice.actions;
